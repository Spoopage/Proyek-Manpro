...
<nav class="relative flex w-full flex-nowrap items-center justify-between bg-black xl:px-44 lg:px-24 md:px-12 px-4 py-2 text-white shadow-dark-mild hover:text-neutral-700 focus:text-neutral-700 lg:flex-wrap lg:justify-start lg:py-4"
    data-twe-navbar-ref>
    <div class="flex w-full flex-wrap items-center justify-between">
        <div class="ms-2">
            <a class="text-xl text-white tracking-widest" href="#">TITAN</a>
        </div>
        ...
        <div class="!visible mt-2 hidden basis-[100%] items-center lg:mt-0 lg:!flex lg:basis-auto"
            ...
            <ul class="list-style-none me-auto flex flex-col ps-0 lg:mt-1 lg:flex-row" data-twe-navbar-nav-ref>
                ...
                <li class="my-4 ps-2 lg:my-0 lg:pe-1 lg:ps-2" data-twe-nav-item-ref>
                    <a href="/donation" class="text-white lg:px-2" aria-current="page" href="#" data-twe-nav-link-ref>Donation</a>
                </li>
                <li class="my-4 ps-2 lg:my-0 lg:pe-1 lg:ps-2" data-twe-nav-item-ref>
                    <a class="text-white lg:px-2" aria-current="page" href="#" data-twe-nav-link-ref>Headers</a>
                </li>
                <li class="my-4 ps-2 lg:my-0 lg:pe-1 lg:ps-2" data-twe-nav-item-ref>
                    <a class="text-white lg:px-2" aria-current="page" href="#" data-twe-nav-link-ref>Pages</a>
                </li>
                <li class="my-4 ps-2 lg:my-0 lg:pe-1 lg:ps-2" data-twe-nav-item-ref>
                    <a class="text-white lg:px-2" aria-current="page" href="#" data-twe-nav-link-ref>Portfolio</a>
                </li>
                <li class="my-4 ps-2 lg:my-0 lg:pe-1 lg:ps-2" data-twe-nav-item-ref>
                    <a class="text-white lg:px-2" aria-current="page" href="#" data-twe-nav-link-ref>Blog</a>
                </li>
                <!-- Dropdown -->
                <li class="my-4 ps-2 lg:my-0 lg:pe-1 lg:ps-2" data-twe-nav-item-ref>
